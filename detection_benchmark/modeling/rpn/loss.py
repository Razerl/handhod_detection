...
class RPNLossComputation(object):
    ...
    def __call__(self, anchors, objectness, box_regression, targets):
        ...
        for objectness_per_level, box_regression_per_level in zip(
            ...
            N, A = objectness_per_level.shape
            box_regression_per_level = box_regression_per_level.view(N, -1, 4)
        ...
        box_loss = box_loss / box_regression.numel()
...
def make_rpn_loss_evaluator(cfg, box_coder):
    ...
    loss_evaluator = RPNLossComputation(matcher, box_coder)
